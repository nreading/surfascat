...
\end{prop}
\begin{proof}
We first argue \eqref{encirc completed} when $U$ is a ring (an honest, non-shielding, allowable curve).
...
Now, we argue \eqref{encirc completed}, starting with the case where $U$ is an I-beam.
