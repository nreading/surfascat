...
$\set{\,\cdot\,,\,\cdot\,}:N\times N\to\rationals$&$\set{\alpha,\gamma}$ is signed adjacency $b_{\alpha_\gamma}$ with the usual convention taking $b_{\alpha\gamma}$ positive in a triangle where $\alpha$ precedes $\gamma$ in clockwise order.\linebreak
