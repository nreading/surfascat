...
(If two leaves are in the interior of the same arc of $T$, necessarily connected to two different non-leaves in two different triangles, we allow isotopies that move them past each other.)
...
Then $p^*(\sum_{i=1}^k\alpha_i)\in\Wall(U)\oplus\Span_\integers\set{L^*:L\in\L}$ of and only if $k=1$.
\end{prop}
\begin{proof}
...
Working on the figure genteel.ps to illustrate this part of the proof...
