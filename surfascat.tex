...
The key to the proof of Proposition~\ref{Wall union no punct} is the following lemma.
...
We extend both bars to non-closed allowable curves $\lambda_l$ and $\lambda_r$ that don't intersect except where they coincide along an edge of $U$.
...
When there is a choice, we always choose the right.
We continue until we reach the boundary.
We first start from an end of $\lambda_l$ and extend so as to never cross any part of $\lambda_l$ or its extension, or $\lambda_r$.
...
Conceivably, the extension never terminates (i.e.\ never reaches the boundary).
...
The allowable curves $\kappa(\alpha)$ and $\kappa(\gamma)$ are non-isotopic and intersect exactly once.
