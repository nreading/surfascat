...
If $U$ is an I-beam, then $\Compat$ is a union of cones $C_{\kappa(T')}$ for near triangulations $T'$.
...
\end{prop}
\begin{proof}
To prove the first assertion, we will show that any lamination compatible with $U$ can be completed to a near triangulation $T'$ such that $\kappa(T')$ is compatible with $U$.
